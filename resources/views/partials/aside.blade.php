<aside id="layout-menu" class="layout-menu menu-vertikal menu bg-menu-theme" style="background-color: #5D7671;">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="{{route('data_arsip.index')}}" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-archive-in"></i>
        <div data-i18n="Basic">Data Surat Berita Acara</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{route('data_arsip.index')}}" class="menu-link">
            <div data-i18n="Notifications">Arsip Surat Berita Acara</div>
          </a>
        </li>
        @if(Auth::user()->role == 'adminn')
          <li class="menu-item">
            <a href="{{route('data_pegawai.index')}}" class="menu-link">
              <div data-i18n="Basic">Pegawai Pengesahan Surat BA</div>
            </a>
          </li>
        @endif
      </ul>
    ...
    @if(Auth::user()->role == 'adminn')
    <li class="menu-item">
  <a href="{{ route('data_mitra.index') }}" class="menu-link menu-toggle">
...
<li class="menu-item">
  ...
  <ul class="menu-sub">
    ...
    <li class="menu-item">
      <a href="https://github.com/themeselection/sneat-html-admin-template-free/issues" target="_blank" class="menu-link"></a>
    </li>
  </ul>
</aside>
