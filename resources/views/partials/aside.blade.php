<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="/" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2" style="font-size: large;">SISTEM INVENTARIS</span>
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Layouts -->
      <li class="menu-item">
        <a href="{{route('data_penerimas.create')}}" class="menu-link">
